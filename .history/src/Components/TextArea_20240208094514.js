    ...
    return (
        <>
            <div className="container" style={{ color: props.mode === 'light' ? 'black' : 'white' }}>
                <h1>Write Here</h1>
                <textarea className="form-control" value={text} onChange={textOnChange} style={{ color: props.mode === 'light' ? 'black' : 'white', color: props.mode === 'light' ? 'black' : 'white' }} id="myBox" rows="8"></textarea>
